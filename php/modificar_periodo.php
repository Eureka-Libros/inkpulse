...
$sql = "UPDATE periodos SET id_calendario=:id_calendario, periodo=:periodo, f_cierre=:f_cierre,
        t_preescolar=:t_preescolar, t_primaria=:t_primaria, t_6_9=:t_6_9, t_10_11=:t_10_11, updated_at=NOW()
        WHERE id=:id";
