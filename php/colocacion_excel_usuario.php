...
// Factura de Venta, Abonos (RC, agregado 2026-09-02) y Devoluciones ahora también traen su
// detalle por documento (tipo+número), igual patrón que REM-CEUR/POS. El total escalar
// ('factura_venta'/'abonos'/'devoluciones') se sigue usando para la fila de "Total general" al pie.
$maxMovimientosWo = 0;
$maxMovimientosPos = 0;
$maxMovimientosFv = 0;
